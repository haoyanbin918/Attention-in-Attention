...
from nets.block_zoo import ST as EF
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, n_segment=8, fold_div=8, place=None,
        ...
        if self.use_ef:
            # print('=> Using VB filter with cdiv: {}'.format(cdiv))
            self.eft = EF(n_segment, use_BN=True)
...
if __name__ == "__main__":
    ...
    net = resnet50(False, num_classes=174, num_segments=8, fold_div=8, place='blockres', cdiv=16)
    net.eval()
