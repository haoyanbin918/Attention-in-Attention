...
def return_diving48(modality):
    ...
    # filename_categories = 'soccer_allframe256_v2j/soccer_classInd.txt'
    if modality == 'RGB':
        root_data = '/data/yanbin/Video_Datasets/'
        filename_imglist_train = '/data/yanbin/Video_Datasets/diving48/trainValTest/train.txt'
        filename_imglist_val = '/data/yanbin/Video_Datasets/diving48/trainValTest/val.txt'
        prefix = '{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix

def return_egaze(modality):
    filename_categories = 106
    # filename_categories = 'soccer_allframe256_v2j/soccer_classInd.txt'
    if modality == 'RGB':
        root_data = '/vireo00/yanbin/'
        filename_imglist_train = '/vireo00/yanbin/EGTEA_Gaze+/trainValTest/train1.txt'
        filename_imglist_val = '/vireo00/yanbin/EGTEA_Gaze+/trainValTest/val1.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_kinetics(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET2
        filename_imglist_train = '/data/vireodata/video_data/kinetics400/trainValTest/train.txt'
        filename_imglist_val = '/data/vireodata/video_data/kinetics400/trainValTest/val.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'somethingv1': return_somethingv1, 'somethingv2': return_somethingv2,
                   ...
                   'diving48': return_diving48, 'egaze': return_egaze
                   }
