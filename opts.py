...
parser.add_argument('--beta', type=int, default=2, help = 'channel splits for input channels, 1 for GST-Large and 2 for GST')
...
parser.add_argument('--test_alphas', type=str, default="4")
parser.add_argument('--test_betas', type=str, default="1")
