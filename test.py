...
def main():
    ...
    # test_alpha_list = [1,2,3]
    # test_beta_list = [1,2,3]
    ...
    # scale_size = 240
    scale_size = (240,320)
    crop_size = 240 if args.full_res else 224 # 224 or 256 (scale_size)
    ...
    log_path = './{}/log_{}_{}_{}_seg{}_crop{}_{}.txt'.format(test_log, args.arch, args.dataset, "-".join(test_nets_list), \
        "-".join(str(a) for a in test_segments_list), str(args.test_crops),\
        crop_size)

    for this_net, this_segment, this_alpha, this_beta, this_weight in zip(test_nets_list, test_segments_list, test_alpha_list, test_beta_list, test_weights_list):
